...
var GameState = {
    ...
    create: function(){
        ...
        this.rightArrow = this.game.add.sprite(60,this.game.world.centerY,'arrow');
        ...
        this.leftArrow = this.game.add.sprite(580,this.game.world.centerY,'arrow');
    ...
    switchAnimal: function(sprite,event){
        ...
        newAnimalMovement.to({x:this.game.world.centerX},250);
        ...
        currentAnimalMovement.to({x: endX},250);
